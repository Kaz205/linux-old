...
# mock -r fedora-39-aarch64  --resultdir . --enable-repo updates-testing kernel-kazuki-6.5.7-cb1.0.fc38.src.rpm
...
make dtbs_install INSTALL_DTBS_PATH=%{buildroot}/boot/dtb-%{kverstr}
cp -r %{buildroot}/boot/dtb-%{kverstr} %{buildroot}/lib/modules/%{kverstr}/dtb
